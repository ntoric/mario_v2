...
func (m *Manager) Start() error {
	if m.cfg.DisablePrinterService {
		log.Println("Printer service disabled via environment variable")
		return nil
	}
	log.Println("In-process printer service active")
	return nil
}

func (m *Manager) Stop() {
	log.Println("In-process printer service stopped")
}

var adapter = bluetooth.DefaultAdapter

// Print is the entry point for printing invoices.
