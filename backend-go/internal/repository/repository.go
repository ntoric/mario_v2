...
func NewRepository(db *sql.DB) *Repository {
	...
	return &Repository{
		...
		Category: &CategoryRepository{db: db, cache: cache},
		Item:     &ItemRepository{db: db, cache: cache},
		Table:    &TableRepository{db: db, cache: cache},
		Order:    &OrderRepository{db: db},
		Bill:     &BillRepository{db: db},
...
func (r *CategoryRepository) GetAll(ctx context.Context, storeID string) ([]models.Category, error) {
	...
	if val, found := r.cache.Get(cacheKey); found {
		if cached, ok := val.([]models.Category); ok {
			return cached, nil
		}
	}
	...
	r.cache.Set(cacheKey, categories, 30*time.Minute)
...
func (r *CategoryRepository) Create(ctx context.Context, c models.Category) error {
	...
	if err == nil {
		r.cache.Delete("categories:" + c.StoreID)
	}
	return err
}
...
func (r *CategoryRepository) Update(ctx context.Context, c models.Category) error {
	...
	if err == nil {
		r.cache.DeleteAllWithPrefix("categories:")
	}
	return err
}
...
func (r *ItemRepository) GetAll(ctx context.Context, storeID string) ([]models.Item, error) {
	...
	if val, found := r.cache.Get(cacheKey); found {
		if cached, ok := val.([]models.Item); ok {
			return cached, nil
		}
	}
	...
	r.cache.Set(cacheKey, items, 30*time.Minute)
	return items, nil
}
...
func (r *ItemRepository) Create(ctx context.Context, i models.Item) error {
	...
	if err == nil {
		r.cache.Delete("items:" + i.StoreID)
	}
	return err
}
...
func (r *ItemRepository) Update(ctx context.Context, i models.Item) error {
	...
	if err == nil {
		r.cache.DeleteAllWithPrefix("items:")
	}
	return err
}
...
func (r *OrderRepository) GetAll(ctx context.Context, storeID, status string) ([]models.Order, error) {
	sqlStr := `
		SELECT o.id, o.store_id, o.table_id, o.table_number, o.status, o.total_amount, o.tax_amount, o.discount_amount,
	...
	for rows.Next() {
		var o models.Order
		var method, statusPay, createdBy sql.NullString
		var itemsBytes []byte
		err := rows.Scan(
			&o.ID, &o.StoreID, &o.TableID, &o.TableNumber, &o.Status, &o.TotalAmount, &o.TaxAmount, &o.DiscountAmount,
...
func (r *OrderRepository) Create(ctx context.Context, o models.Order) error {
	...
	sqlStr := `INSERT INTO orders (id, store_id, table_id, table_number, status, total_amount, tax_amount, discount_amount, payment_method, created_by)
	           VALUES ($1, $2, $3, $4, 'active', $5, $6, $7, $8, $9)`
	var payMethod interface{}
	if o.PaymentMethod != "" {
		payMethod = o.PaymentMethod
	}

	_, err = tx.ExecContext(ctx, sqlStr,
		o.ID, o.StoreID, o.TableID, o.TableNumber, o.TotalAmount, o.TaxAmount, o.DiscountAmount, payMethod, o.CreatedBy,
	)
	if err != nil {
		return err
	}
...
func (r *BillRepository) GetAll(ctx context.Context, storeID string) ([]models.Bill, error) {
	sqlStr := `
		SELECT b.id, b.store_id, b.order_id, b.table_number, b.invoice_no, b.subtotal, b.tax_total, b.discount, b.total,
		       b.payment_method, b.customer_name, b.is_printed, b.generated_at, b.generated_by,
		       COALESCE(
		         json_agg(
		           json_build_object(
		             'itemId', oi.item_id,
	...
	for rows.Next() {
		var b models.Bill
		var method, customer, generatedBy sql.NullString
		var itemsBytes []byte
		err := rows.Scan(
			&b.ID, &b.StoreID, &b.OrderID, &b.TableNumber, &b.InvoiceNo, &b.Subtotal, &b.TaxTotal, &b.Discount, &b.Total,
			&method, &customer, &b.IsPrinted, &b.GeneratedAt, &generatedBy,
			&itemsBytes,
		)
		if err != nil {
			return nil, err
...
func (r *BillRepository) Create(ctx context.Context, b models.Bill) error {
	...
	`
	var payMethod, custName interface{}
	if b.PaymentMethod != "" {
	...
	_, err := r.db.ExecContext(ctx, sqlStr,
		b.ID, b.StoreID, b.OrderID, b.TableNumber, b.InvoiceNo, b.Subtotal, b.TaxTotal, b.Discount, b.Total, payMethod, custName, b.GeneratedBy,
	)
	return err
}
...
func (r *BillRepository) QueueBill(ctx context.Context, queueID, storeID, orderID string, billData []byte) error {
	_, err := r.db.ExecContext(ctx,
		"INSERT INTO bill_queue (id, store_id, order_id, bill_data, status) VALUES ($1, $2, $3, $4, 'pending')",
		queueID, storeID, orderID, billData,
	)
	return err
}
