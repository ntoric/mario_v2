...
class ApiService {
  ...
  // Print
  async printInvoice(printData: any) {
    return this.fetch('/print/invoice', {
      method: 'POST',
      body: JSON.stringify(printData),
    });
  }

  async printKOT(printData: { orderId: string; printerConfig?: any }) {
    return this.fetch('/print/kot', {
      method: 'POST',
      body: JSON.stringify(printData),
    });
  }
  ...
  async getPrinters() {
    return this.fetch('/print/printers');
  }
